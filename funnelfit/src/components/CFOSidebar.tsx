...
const CFOSidebar: React.FC<CFOSidebarProps> = ({ 
  onNavigate, 
  accountType, 
  email, 
  activePage,
  ...
  const isActive = (page: string, tab?: string) => {
    if (tab) {
  ...
  return (
    <div className="w-64 bg-primary-600 border-r border-primary-700 flex flex-col">
      ...
      <nav className="flex-1 p-4 space-y-2">
        <button
          onClick={() => {
            if (activePage === 'cfo-dashboard' && setActiveTab) {
              setActiveTab('overview')
            } else {
              onNavigate('cfo-dashboard', accountType, email)
            }
          }}
          className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left transition-colors ${
            isActive('cfo-dashboard') || isActive('overview', 'overview')
        ...
        <button
          ...
          className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left transition-colors ${
            isActive('cfo-client-management')
              ? 'bg-primary-500 text-white border border-primary-400'
              : 'text-primary-100 hover:bg-primary-500 hover:text-white'
          }`}
        >
        ...
        <button
          onClick={() => onNavigate('messaging', accountType, email)}
          className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left transition-colors ${
        ...
        <button
          ...
          className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left transition-colors ${
            isActive('projects-tasks') || isActive('cfo-client-workspace')
              ? 'bg-primary-500 text-white border border-primary-400'
              : 'text-primary-100 hover:bg-primary-500 hover:text-white'
          }`}
        >
        ...
        <button
            onClick={() => onNavigate('invoice-tracking', accountType, email)}
            className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left transition-colors ${
        ...
        <button
          onClick={() => onNavigate('cfo-profile-management', accountType, email)}
          className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left transition-colors ${
